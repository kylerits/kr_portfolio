<template>
  <div class="service-list relative flex lg:items-center flex-wrap lg:flex-nowrap w-full">
    <!-- Info Column -->
    <div class="column relative w-full lg:w-1/2 order-2 lg:order-1 lg:pr-12 z-10">
