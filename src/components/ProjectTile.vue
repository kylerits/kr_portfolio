  ...
  <div class="project relative w-full p-4 bg-green-600 rounded-lg shadow-xl overflow-hidden">
    ...
    <div class="project-inner relative w-full bg-white rounded-lg p-4 mt-32">
      ...
      <div class="project-links">
        <g-link
          :to="projectData.path"
          class="button button-sm mr-3 text-indigo-200 bg-indigo-700 hover:bg-indigo-800 mb-2"
        >Read More</g-link>
        <a
          :href="projectData.link"
          class="button button-sm mr-3 tracking-wider text-red-200 bg-red-600 hover:bg-red-700 mb-2"
        >View Now</a>
      </div>
    </div>
  </div>
