  ...
  <Layout>
    <article id="about">
      ...
      <section class="container mx-auto relative py-12 lg:py-24">
        <div class="content mx-auto lg:w-2/3 py-12">
          ...
          <p>Web design and development is an industry growing at an incredible pace with new technologies being introduced every day. Learning is something that I have to do if I want to continue. You show me someone that calls themselves a master at web design, and in two month's time I can show you someone out of date. I work very much through trial and error and I always try to learn from my mistakes. I will always strive for my next project to be better than this one, and I hope for web design and front-end development to be something that I am sort of good at.</p>
        </div>
      </section>
    </article>
  </Layout>
